...
--
-- TABLE: devices (REVERTED - NO SWING/SLEEP)
--
...
CREATE SEQUENCE public.device_overrides_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE SEQUENCE public.face_profiles_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER TABLE ONLY public.face_profiles ADD CONSTRAINT face_profiles_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.users ADD CONSTRAINT users_email_key UNIQUE (email);
ALTER TABLE ONLY public.face_profiles ADD CONSTRAINT face_profiles_user_id_key UNIQUE (user_id);
ALTER TABLE ONLY public.sensor_data ADD CONSTRAINT sensor_data_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
ALTER TABLE ONLY public.face_profiles ADD CONSTRAINT face_profiles_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id);
